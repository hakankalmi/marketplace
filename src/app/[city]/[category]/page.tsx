...
const categoryContent: Record<string, { intro: string; benefits: string[]; faq: { q: string; a: string }[] }> = {
  ...
  'koltuk-yikama': {
    intro: 'Koltuk yıkama, ev ve ofis mobilyalarınızın temizliği ve ömrünü uzatması için kritik bir hizmettir. Profesyonel koltuk yıkama firmaları, yerinde uygulama ile koltuk, berjer, sandalye ve diğer döşemeli mobilyalarınızı derinlemesine temizler.',
    benefits: [
      'Yerinde koltuk yıkama hizmeti',
      'Leke çıkarma ve koku giderme',
      'Anti-bakteriyel uygulama',
      'Kumaş tipine özel temizlik',
      'Hızlı kuruma teknolojisi',
      'Sigortalı ve garantili hizmet',
    ],
    faq: [
      { q: 'Koltuk yıkama yerinde mi yapılır?', a: 'Evet, koltuk yıkama genellikle evinizde veya ofisinizde yerinde yapılır. Profesyonel ekipmanlarla 2-4 saat içinde tamamlanır.' },
      { q: 'Koltuk yıkama sonrası ne kadar sürede kurur?', a: 'Modern ekipmanlarla yıkanan koltuklar genellikle 4-6 saat içinde kurur. Havalandırma ile bu süre kısaltılabilir.' },
    ],
  },
};
