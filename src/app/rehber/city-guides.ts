/* ───── Şehir Bazlı Halı Yıkama Rehberleri ───── */

import type { GuideArticle } from './guides';

export const cityGuides: GuideArticle[] = [
  {
...
Avrupa yakasında fiyatlar genellikle %5-10 daha yüksektir. Bunun nedeni kira maliyetlerindeki farktır.`,
      ...
      {
        heading: 'İstanbul Halı Yıkama — İlçe Bazlı Fiyat Karşılaştırması',
...
**İpucu:** Kendi ilçenize yakın firma seçmek ulaşım ücreti riskini ortadan kaldırır. Platform üzerinden ilçenize göre filtreleme yapabilirsiniz.`,
      ...
      {
        heading: 'İstanbul Halı Yıkama Hizmeti Alırken Dikkat Edilmesi Gerekenler',
...
**Doğal Kaynak Suyu İddiası:** Bazı firmalar Uludağ kaynak suyuyla halı yıkama yaptığını iddia eder. Bu pazarlama söylemidir — profesyonel halı yıkamada suyun kaynağından çok filtreleme sistemi önemlidir. Firmadan arıtma/filtreleme sistemi olup olmadığını sorun.`,
  ...
  {
    slug: 'antalya-hali-yikama',
    city: 'Antalya',
    citySlug: 'antalya',
    title: 'Antalya Halı Yıkama Rehberi — İlçe Bazlı Fiyatlar ve Firmalar',
    metaTitle: 'Antalya Halı Yıkama | İlçe Bazlı Fiyatlar ve En İyi Firmalar 2026',
    metaDescription: 'Antalya halı yıkama fiyatları ilçe bazlı karşılaştırma. Muratpaşa, Konyaaltı, Kepez, Alanya, Manavgat ve tüm ilçelerde en iyi halı yıkama firmaları.',
    datePublished: '2026-03-09',
    dateModified: '2026-03-09',
    category: 'hali-yikama',
    readingTime: 7,
    heroEmoji: '🏖️',
    intro: 'Antalya, Türkiye\'nin turizm başkenti ve Akdeniz\'in en sıcak şehirlerinden biridir. Yaz aylarında 40°C\'yi aşan sıcaklar, yüksek nem ve sahil kumu halılarda ciddi hijyen sorunu yaratır. Turizm sezonunda otel ve pansiyonlar profesyonel halı yıkama hizmetine yoğun talep gösterir. Bu rehberde [Antalya halı yıkama](/antalya-hali-yikama-firmalari) fiyatlarını ilçe bazlı karşılaştırıyor ve Akdeniz iklimine özel dikkat edilmesi gereken noktaları paylaşıyoruz.',
    sections: [
      {
...
**İpucu:** Sezon dışında (Ekim-Mart) halı yıkatmak hem fiyat hem teslimat açısından çok daha avantajlıdır. Firmalar boş kapasiteyle çalışır, pazarlık payı yüksektir.`,
      },
      {
        heading: 'Antalya Halı Yıkama — Akdeniz İklimi ve Turizm Etkisi',
        content: `Antalya'nın sıcak ve nemli Akdeniz iklimi halı bakımını doğrudan etkiler:

**Nem ve Küf Riski:** Antalya'da yıllık ortalama nem %65-70 civarındadır. Kış aylarında yağmur yoğundur. Halılarda küf, toz akarı ve bakteri üremesi İç Anadolu'ya göre 2-3 kat hızlıdır. Yılda en az 2 kez profesyonel halı yıkama şarttır.

**Kum ve Toz:** Sahil bölgelerinde halılara kum girişi kaçınılmazdır. Kum taneleri halı liflerini aşındırır ve ömrünü kısaltır. Düzenli profesyonel yıkama halınızın ömrünü uzatır.

**Turizm Sezonu Etkisi:** Mayıs-Haziran'da apart daire ve pansiyon sahipleri toplu halı yıkatır. Firmalar çok yoğundur, teslimat 7-10 güne çıkabilir. Erken sipariş verin veya Nisan'da yıkatın.
...
[Antalya halı yıkama firmaları](/antalya-hali-yikama-firmalari) — Antalya'daki doğrulanmış firmaları ilçe bazlı filtreleyebilir, [fiyatları karşılaştırabilir](/rehber/hali-yikama-fiyatlari) ve güvenle sipariş verebilirsiniz.`,
      },
      {
        ...
        content: `**Otel/Villa Temizliği Deneyimi:** Antalya'da birçok halı yıkama firması otellere hizmet verir. Bu firmalar büyük alan temizliğinde (100+ m²) deneyimlidir ve endüstriyel kapasiteye sahiptir. Villa veya büyük ev halıları için bu firmaları tercih edebilirsiniz.

**Sezonluk Fiyat Farkı:** Bazı firmalar turizm sezonunda %15-20 zam yapar. Fiyat teklifi alırken sezonu sorun. Ekim-Mart arası en uygun fiyatları bulabilirsiniz.

**Sahil Evi Halıları:** Sahile yakın evlerde yaşıyorsanız halılarınızda tuz ve kum birikimi olur. Firmaya bu durumu belirtin — bazı firmalar tuz arındırma ve kum temizleme için ek işlem uygular.

**Kilim ve El Dokuması:** Antalya ve çevresinde (özellikle Döşemealtı) geleneksel kilim üretimi vardır. Döşemealtı kilimleri hassas yıkama gerektirir. Firmadan kilim yıkama tecrübesi olup olmadığını ve hangi yöntemi kullandığını sorun.

**Uzak İlçe Teslimatı:** Alanya-Antalya merkez arası 130+ km'dir. Alanya, Manavgat ve Gazipaşa'da yerel firma tercih etmek teslimat süresini yarıya indirir.`,
      },
    ],
    faq: [
